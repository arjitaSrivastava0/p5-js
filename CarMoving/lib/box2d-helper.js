...
var createWorld = function(scale, gravityVector) {
	...
	var doSleep = true;
  	...
  	scaleFactor = scale;
  //new box2d.b2World(new box2d.b2Vec2(gravityVector.x,gravityVector.y), doSleep);
...
var setFixtureProperty = function(bodyFixDef, properties, bodyWrapper){
		...
		Object.defineProperties(bodyWrapper, {
	        "static": {
	            "get": function () {
	    ...
	    Object.defineProperties(bodyWrapper, {
	        "velocity": {
	            "get": function () {
	                return scaleToPixels(this.body.GetLinearVelocity());
	            },
	            "set": function (x) {
	    ...
	    Object.defineProperties(bodyWrapper, {
	        "centerOfMass": {
	            "get": function () {
	                return scaleToPixels(this.body.GetWorldCenter());
	            },
	        }
	    });
	    Object.defineProperties(bodyWrapper, {
		...
		//bodyWrapper.fixtures.push(bodyWrapper);
...
var updateJointProperties = function(bodyA, bodyB, joint, properties){
	...
	if (properties.jointType == 'distance') {
       ...
       if (props.xy != undefined) joint.localAnchorA = b2scaleTo(props.xy);
    	...
    	joint.Initialize(bodyA.body, bodyB.body, props.xy == undefined?bodyA.body.GetWorldCenter():b2scaleTo(props.xy));
